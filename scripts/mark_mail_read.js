...
if (!MESSAGE_ID) {
  console.error('Usage: mark_mail_read.js <messageId>');
  process.exit(2);
}
...
async function markRead() {
  ...
  const url = `https://graph.microsoft.com/v1.0/users/${encodeURIComponent(MAILBOX_UPN)}/messages/${encodeURIComponent(MESSAGE_ID)}`;
