...
Adli inceleme bulgularına göre olay, doğrudan veritabanı sızması yoluyla değil; **destek portal uygulamasının yetkili bir kullanıcısı üzerinden gerçekleştirilmiştir.** Saldırganın söz konusu kullanıcıya ait kimlik bilgilerini ele geçirerek veya kullanıcı makinesinden uzaktan sorgu atarak veri çektiği değerlendirilmektedir.
